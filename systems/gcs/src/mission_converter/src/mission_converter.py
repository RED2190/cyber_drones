...
from .wpl_generator import points_to_wpl
from ..topics import ComponentTopics, MissionActions
...
class MissionConverterComponent(BaseComponent):
    def __init__(self, component_id: str, bus: SystemBus):
        super().__init__(
            ...
            topic=ComponentTopics.MISSION_CONVERTER,
            bus=bus,
        )
